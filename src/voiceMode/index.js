import VoiceModeApp from './VoiceModeApp.js';
import ErrorBoundary from '../components/ErrorBoundary.js';
import { attachGlobalErrorHandlers, clearFatalError, renderFatalError, DataLoadingError } from '../utils/errorHandling.js';
...
try {
  ...
  root.render(
    ReactGlobal.createElement(
      ErrorBoundary,
      null,
      ReactGlobal.createElement(VoiceModeApp)
    )
  );
} catch (error) {
