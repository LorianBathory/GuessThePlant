...
- 📈 Фиксированное количество вопросов: 6 в первом раунде, 7 во втором и 5 в третьем (если подходящих вопросов меньше, раунд завершается раньше) с сохранением общего счёта между раундами.
- 🏆 Дифференцированное начисление очков — 1/2/3 балла за вопрос в первом, втором и третьем раундах соответственно.
...
- 🌐 Переключение языка интерфейса (русский или английский) выполняется в меню, а подписи растений (русский, английский или латинский вариант) можно менять прямо во время раундов.
...
## Как проходит игра
1. При открытии сайта появляется меню: в нём можно выбрать язык интерфейса и нажать «Начать игру» — после этого стартует Раунд 1 (Easy) с шестью вопросами соответствующей сложности (или меньше, если не хватает данных).
...
4. Раунд 2 (Medium) и Раунд 3 (Hard) стартуют по кнопке. Во втором раунде задаётся семь вопросов, в третьем — пять, но раунд может завершиться раньше, если подходящих вопросов меньше.
5. По завершении Раунда 3 показывается финальный результат, а затем открывается меню с кнопкой перезапуска и переключателями языка интерфейса.
